...
(define-api update-account :patch "/api/v1/accounts/update_credentials" ()
  ...
  nil)
(define-api get-account-followers :get "/api/v1/accounts/~D/followers" (id) (&key max-id since-id limit)
  (list <account>))
(define-api get-account-following :get "/api/v1/accounts/~D/following" (id) (&key max-id since-id limit)
  (list <account>))
(define-api get-account-statuses :get "/api/v1/accounts/~D/statuses" (id)
...
(define-api get-account-relationships :get "/api/v1/accounts/relationships" () ((ids "id" :array))
  (list <relationship>))
(define-api search-accounts :get "/api/v1/accounts/search" () ((query "q") &key limit)
  (list <account>))
(define-api get-blocks :get "/api/v1/blocks" () (&key max-id since-id limit) (list <account>))
(define-api get-favourites :get "/api/v1/favourites" () (&key max-id since-id limit) (list <status>))
(define-api get-follow-requests :get "/api/v1/follow_requests" () (&key max-id since-id limit)
  (list <account>))
...
(define-api follow-remote-user :post "/api/v1/follows" () (uri) <account>)
(define-api get-instance :get "/api/v1/instance" () () <instance>)
(define-api upload-media :post "/api/v1/media" () (file) <attachment>)
(define-api get-mutes :get "/api/v1/mutes" () (&key max-id since-id limit) <account>)
(define-api get-notifications :get "/api/v1/notifications" () (&key max-id since-id limit)
  (list <notification>))
(define-api get-notification :get "/api/v1/notification/~D" (id) () <notification>)
